...
export default function Home() {
  ...
  return (
    <div ref={containerRef} className="relative overflow-x-hidden">
      <SEO pageKey="home"
        title="Stockton Marketing & Web Design Agency"
        ...
        preloadImage={heroBg}
        keywords="Stockton CA marketing agency, marketing agency Stockton CA, marketing agency in Stockton California, marketing companies in Stockton CA, best marketing agency Stockton, top marketing agency Stockton, Stockton CA creative studio, creative agency Stockton, creative agency in Stockton CA, best creative agency Stockton, Stockton CA web development services, web development agency Stockton, web developer Stockton CA, web development company Stockton, custom web development Stockton, web design agency Stockton CA, web design agency in Stockton California, web designer Stockton, website designer Stockton, website design Stockton CA, custom web design Stockton, responsive web design Stockton, mobile web design Stockton, WordPress web design Stockton, WordPress developer Stockton, Webflow agency Stockton, Webflow developer Stockton, Shopify web design Stockton, Shopify developer Stockton, ecommerce web design Stockton, ecommerce development Stockton, landing page design Stockton, website redesign Stockton, branding agency Stockton, brand identity Stockton CA, brand strategy Stockton, logo design Stockton CA, design agency Stockton, graphic design Stockton, graphic designer Stockton, advertising agency Stockton, ad agency Stockton CA, digital marketing agency Stockton, digital marketing Stockton CA, SEO agency Stockton, SEO services Stockton CA, SEO company Stockton, local SEO Stockton, Google My Business Stockton, content marketing Stockton, social media marketing Stockton, social media agency Stockton, Instagram marketing Stockton, Facebook ads Stockton, Google Ads Stockton, PPC Stockton, email marketing Stockton, marketing automation Stockton, HubSpot agency Stockton, AI marketing agency Stockton, AI agency Stockton, AI automation Stockton, UX design Stockton, UI design Stockton, product design Stockton, app design Stockton, SaaS web design Stockton, startup branding Stockton, small business marketing Stockton, small business web design Stockton, real estate marketing Stockton, restaurant web design Stockton, law firm web design Stockton, medical web design Stockton, contractor web design Stockton, Lodi web design, Tracy web design, Modesto web design, Manteca web design, Lathrop web design, Ripon web design, Elk Grove web design, Sacramento web design, San Joaquin County web design, Central Valley web design agency, Bay Area web design agency, Northern California web design agency, marketing agency near me Stockton, web design near me Stockton"
        jsonLd={{
